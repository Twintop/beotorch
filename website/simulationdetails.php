...
?>
			...
			<div class="panel panel-default">
				...
				<div id="SimulationResults" class="panel-collapse collapse in" style="padding-left: 15px;">
                    ...
                    if ($simulation->ScaleFactors == 1)
                    { 
                        echo "<table class=\"table table-bordered table-hover table-striped table-stat-weights\" id=\"statWeightsTable\">
                        ...
                        echo "<table class=\"table table-bordered table-hover table-striped table-stat-weights\" id=\"statWeightsNormalizedTable\">
                                    <caption>Normalized Scaling Factors / Stat Weights</caption>
                                    <thead>
                                        <tr>";
            ...
            ?>
           	...
           	$(document).ready(function() {
                ...
                <?php if ($simulation->SimulationActors[0] && $simulation->SimulationActors[0]->CharacterJSON)
                {?>
                ...
                $("#statWeightsTable thead th").each(function(x){
                    $(this).width($(this).width()+25);
                });

                $("#statWeightsNormalizedTable").DataTable({
                    "dom": '',
                    "order": [[ 0, "asc" ]],
                    "autoWidth": true,
                    "paging": false
                ...
                $("#statWeightsNormalizedTable thead th").each(function(x){
                    $(this).width($(this).width()+25);
                });
            <?php    }
            }?>
